...
class ChromaVectorStore:
    ...
    def similarity_search(self, query, k, max_distance=0.7):
    ...
    async def asimilarity_search(self, query, k, max_distance=0.7):
        ...
        if (
            ...
            or not result["distances"][0][0]
            or not result["documents"]
            or not result["documents"][0]
            or not result["documents"][0][0]
        ):
            return results
